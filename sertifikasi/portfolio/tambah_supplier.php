                ...
                <div class="form-group">
                  ...
                  <div class="panel-group">
                    ...
                    <div class="panel-body">
                      <input type="number" class="form-control" id="kode_supplier" name="kode_supplier" autocomplete="on" placeholder="Input Kode Supplier" required>
                    </div>
                  </div>
                  ...
                  <div class="panel-group">
                    ...
                    <div class="panel-body">
                      <input type="text" class="form-control" id="nama_supplier" name="nama_supplier" autocomplete="on" placeholder="Input Nama Supplier" required>
                    </div>
                  </div>
                  ...
                  <div class="panel-group">
                    ...
                    <div class="panel-body">
                      <input type="text" class="form-control" id="alamat_supplier" name="alamat_supplier" autocomplete="on" placeholder="Input Alamat Supplier" required>
                    </div>
                  </div>
                  ...
                  <div class="panel-group">
                    ...
                    <div class="panel-body">
                      <input type="text" class="form-control" id="kontak_supplier" name="kontak_supplier" autocomplete="on" placeholder="Input Kontak Supplier" required>
                    </div>
                  </div>
