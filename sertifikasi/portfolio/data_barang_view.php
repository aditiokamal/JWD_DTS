...
<body>
    ...
    <div class="service_area">
        <div class="container">
            ...
            <!-- konten -->
            <a href="tambah_barang.php"><button class="btn btn-primary">Tambah Data</button></a>
            <a href="export_barang.php"><button class="btn btn-success">Export Excel</button></a>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success" href="edit_barang.php?no=<?php echo $d['no']; ?>">Edit</a>
                                        <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin akan hapus menghapus data ?')" href="delete_barang_aksi.php?no=<?php echo $d['no']; ?>">Delete</a>
                                    <td>
                                </tr>
                        </tbody>
                    <?php } ?>
