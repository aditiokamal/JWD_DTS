...
<body style="color:#fff; background-color: #1d2124;">
  ...
  <br />
  <h3 class="d-flex justify-content-center">VOLUME SILINDER</h3>
  <br />
  <!-- Input -->
        ...
        <div class="form-group">
          ...
          <div class="panel-group">
            ...
            <div class="panel-body">
              <input type="number" class="form-control" id="radius" name="radius" autocomplete="on" required>
            </div>
          </div>
      ...
      <div class="panel-group">
        ...
        <div class="panel-body">
          ...
          if (isset($_POST['hitung'])) {
            ...
            echo "Radius : $input1<br>";
            echo "Tinggi : $input2<br>";

            echo "<hr>";
            echo "Volume Silinder : " . volumeSilinder($input1, $input2) . "<br>";
          }
          ?>
        </div>
