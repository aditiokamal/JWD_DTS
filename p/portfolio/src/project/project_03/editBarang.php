<?php
    ...
    $no	= $_GET['no'];
    $data = mysqli_query($conn,"SELECT * FROM maki_tb_barang WHERE no='$no'");
...
<body>
    <div class="container-fluid">
        ...
        <br />
        <h3 class="d-flex justify-content-center">Edit Data Barang</h3>
        <!-- Input -->
        <div class="row justify-content-center">
            <div class="col-md-4">
                ...
                <br /><a href="home.php"><button class="btn btn-danger">
                        ...
                        <form action="editBarangAksi.php" method="POST">
                            ...
                            <input type="hidden" name="no" value="<?php echo $d['no'] ?>">
                                ...
                                <div class="panel-group">
                                    ...
                                    <div class="panel-body">
                                        <input type="text" class="form-control" id="merk" name="merk" value="<?php echo $d['merk'] ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="panel-group">
                                    ...
                                    <div class="panel-body">
                                        <input type="text" class="form-control" id="warna" name="warna" value="<?php echo $d['warna'] ?>" required>
                                    </div>
                                </div>
